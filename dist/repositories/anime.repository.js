...
function addAnime(body) {
    return __awaiter(this, void 0, void 0, function () {
        var name, gender, episodes, seasons;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    name = body.name, gender = body.gender, episodes = body.episodes, seasons = body.seasons;
                    return [4 /*yield*/, connection_database_1.default.query("INSERT INTO animes (name, gender, episodes, seasons) VALUES ($1, $2, $3, $4);", [name, gender, episodes, seasons])];
...
function getAnimes() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, connection_database_1.default.query("SELECT * FROM animes;")];
                case 1:
                    result = _a.sent();
